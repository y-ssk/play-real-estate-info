...
| **UX・情報設計（E2・段1で発覚）** | **機能一覧・画面一覧・画面遷移・導線/トップハブ・画面別のMVP/v1/v2割付**。正の見取り図＝`docs/05`（予定）。`ADR-0025` の外→内レンズで起こす。トップ＝「何起点で検索するか」を束ねる入口ハブ(都県/市区町村逆引き・地図選択→詳細・条件→候補/一覧)＋メニュー/関連リンク等。機能①〜⑦は妥当 | 🔲 | 段1スライス(地図描画)・`ADR-0025` |
