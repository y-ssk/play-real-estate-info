...
| 2b | 駅の合計乗降客数を面塗り（実データETL・XKT015） | F1・F2/S1 | XKT015タイルスイープ→LineString→代表点→市区町村→`S12_001g`重複排除→2023(`S12_057`)合計→`metric_value` | 駅乗降客数で色分け。取得はオーナー実行(鍵)。本丸ETL(層1手厚く) | 🔲 |
